...
func MailRecipientsByMailID(db XODB, mailID int64) ([]*MailRecipient, error) {
	var err error
...
func MailRecipientsByRecipientID(db XODB, recipientID int64) ([]*MailRecipient, error) {
	var err error
...
func MailRecipientByID(db XODB, id int64) (*MailRecipient, error) {
	var err error
...
func MailRecipientByMailIDRecipientID(db XODB, mailID int64, recipientID int64) (*MailRecipient, error) {
	var err error
