...
func (a *Address) Insert(db XODB) error {
	...
	// run query
	XOLog(sqlstr, a.Address)
	res, err := db.Exec(sqlstr, a.Address)
	if err != nil {
		return err
	}
...
func (a *Address) Update(db XODB) error {
	...
	// run query
	XOLog(sqlstr, a.Address, a.ID)
	_, err = db.Exec(sqlstr, a.Address, a.ID)
	return err
}
...
func AddressByID(db XODB, id int) (*Address, error) {
	var err error
	...
	err = db.QueryRow(sqlstr, id).Scan(&a.ID, &a.Address)
	if err != nil {
		return nil, err
	}
...
func AddressByAddress(db XODB, address string) (*Address, error) {
	...
	err = db.QueryRow(sqlstr, address).Scan(&a.ID, &a.Address)
	if err != nil {
		return nil, err
	}
